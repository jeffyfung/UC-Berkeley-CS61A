...
def roll_dice(num_rolls, dice=six_sided):
    ...
    for _ in range(num_rolls):
        ...
        if out == 1:
            return_one = True
    return 1 if return_one else accu
...
def swine_align(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 4a
    "*** YOUR CODE HERE ***"
    #check if both scores are positive
    #find GCD of player's score
    #cond: if GCD > 10
...
def more_boar(player_score, opponent_score):
    ...
    if score_diff > -3 and score_diff < 0:
        return True
    else:
        return False
    # END PROBLEM 4b
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    "*** YOUR CODE HERE ***"
    turn = 0
    strategy_dict = {0: strategy0, 1: strategy1}
    score_dict = {0: score0, 1: score1}
    while score_dict[0] < goal and score_dict[1] < goal:
        active_strategy = strategy_dict[who]
        score = take_turn(active_strategy(score_dict[who], score_dict[other(who)]), score_dict[other(who)], dice)
        score_dict[who] += score
        if not extra_turn(score_dict[who], score_dict[other(who)]):
            who = other(who)
        turn += 1
        #print(score_dict)
        #print(turn)
        say = say(score_dict[0], score_dict[1])
    # END PROBLEM 5
    ...
    # END PROBLEM 6
    score0, score1 = score_dict[0], score_dict[1]
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    "*** YOUR CODE HERE ***"
    # current score
    def compare_gain(score0, score1):
        ...
        if gain > running_high:
            ...
            print('{} point(s)! The most yet for Player {}'.format(gain, who))
...
def make_averaged(original_function, trials_count=1000):
    ...
    # BEGIN PROBLEM 8
    "*** YOUR CODE HERE ***"
    def compute_average(*arg):
        output = 0
        counter = 0
        while counter < trials_count:
            output += original_function(*arg)
            counter += 1
        #print(output)
        #print(counter)
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    for num_roll in range(1, 11):
        output = make_averaged(roll_dice, trials_count)(num_roll, dice)
        if output > max_val:
            max_val = output
...
def extra_turn_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 11
    cond1 = extra_turn(score, opponent_score)
    out = piggypoints_strategy(score, opponent_score, cutoff, num_rolls)
    cond2 = out==0 and not extra_turn(score, opponent_score)
    print(cond1)
    print(cond2)
    if cond1 or cond2==0:
        return 0
